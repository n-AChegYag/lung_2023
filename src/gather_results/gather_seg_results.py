...
if __name__ == '__main__':
    ...
    PRED_PATH = '/home/acy/data/lung/log/231105_trans_b2_seg_32_0.001/lightning_logs/version_0/pred'
    ...
    metrics_df = pd.DataFrame(index=os.listdir(PRED_PATH), columns=[
        'vr', 
        'cd', 
        'dice', 
        'hd95', 
    ...
    for patient in tqdm(os.listdir(PRED_PATH)):
        try:
            # load data
            SMC.pred = sitk.ReadImage(os.path.join(PRED_PATH, patient, 'pred.nii.gz'))
    ...
    metrics_df.to_csv(f'/home/acy/data/lung/try/231106_corrected_0.001_all_b2.csv')